...
export function CommandCenter() {
  ...
  return (
    ...
    >
      {/* Hero: identity + orb + command + trace, one dominant surface per screen */}
      <GlassSurface hero radius="xl" style={{ padding: '40px 28px 32px' }}>
        <header style={{ textAlign: 'center', marginBottom: 28 }}>
          <h1 className="cima-display" style={{ fontSize: 26 }}>
            CIMA OS
          </h1>
          <p style={{ fontSize: 13.5, color: 'var(--cima-text-secondary)', marginTop: 6 }}>
      ...
      {/* Asymmetric bento: wide column stacks Activity + Today, narrow column holds Clients */}
      <div className="cima-bento">
        <div className="cima-bento-side">
          <ActivityFeed />
          <TodayPanel />
        </div>
        <ClientList />
